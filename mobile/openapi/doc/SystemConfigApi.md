...
[**getMapDark**](SystemConfigApi.md#getmapdark) | **GET** /system-config/map-dark | 
[**getMapLight**](SystemConfigApi.md#getmaplight) | **GET** /system-config/map-light | 
...
try {
    api_instance.getMapDark();
} catch (e) {
    print('Exception when calling SystemConfigApi->getMapDark: $e\n');
}
```
...
try {
    api_instance.getMapLight();
} catch (e) {
    print('Exception when calling SystemConfigApi->getMapLight: $e\n');
}
```
